...
function Header() {
    ...
    return (
      <div className="Header, flex justify-between shadow-lg bg-black text-white p-2">
        ...
        <img className="Logo, w-40" src="https://img.freepik.com/premium-vector/small-house-with-small-orange-front-sign-that-says-yogurt_1205884-2957.jpg?size=626&ext=jpg"></img>
        </div>
